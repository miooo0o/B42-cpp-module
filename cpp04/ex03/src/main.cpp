...
///				- AMateria class
/// @done	Implement the Materias concrete classes Ice and Cure.
///				- Ice class
///				- Cure class
...
/// 		They equip the Materias in the first empty materia they find.
/// 		This means, in this order: from materia 0 to materia 3.
/// 		In case they try to add a Materia to a full inventory, or `use/unequip` an un existing Materia,
...
///	@todo	The `use(int, ICharacter&)` member function will have to use the Materia at the materia[idx],
